...
> ✍ Hello! My name is Thanh Tuan (Harry), and I work in Cyber ​​Security. I am passionate about protecting digital environments and ensuring data security. I regularly research to identify vulnerabilities, analyze threats, and develop effective strategies to protect networks and systems. With a solid foundation in cybersecurity principles and hands-on experience with tools such as Kali Linux, Metasploit, Bupsuite, Nmap, Nessus, Nikto, Wireshark, SIEM (Wazuh, ELK, OpenSearch, Splunk..), Volatility, Docker,...and various network analysis tools.
...
<table style="width:100%;">
  <tr>
    <td>
      ...
      <br>
      <br>
      👉 Tools: Kali Linux, Metasploit, Bupsuite, Nmap, Nessus, Nikto, Wireshark, SIEM (Wazuh, ELK, OpenSearch,..), Volatility 3, Docker,...
    </td>
    <td>
      <p align="center"> 
